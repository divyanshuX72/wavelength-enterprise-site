...
<body class="bg-wood-dark text-gray-100 antialiased font-sans">
  ...
  <main class="max-w-6xl mx-auto px-4 sm:px-6 py-10">
    ...
    <section class="relative bg-cover bg-center flex items-center justify-center text-center text-white overflow-hidden"
      style="background-image:url('frontend/images/ai_tv_unit_1770204842451.png'); min-height:clamp(40vh, 50vh, 56vh);">
  ...
  <div class="fab-container">
    ...
    <a href="https://wa.me/919373154925" target="_blank" class="fab-btn" style="background:#25D366;color:#fff" title="Chat on WhatsApp">

...
<body class="bg-wood-dark text-gray-100 antialiased font-sans">
  ...
  <main>
    ...
    <section style="padding:48px 0;background:linear-gradient(135deg,rgba(26,18,11,0.95),rgba(42,26,18,0.98))">
      <div class="max-w-6xl mx-auto" style="padding:0 var(--container-pad,1rem)">
        <!-- Section label -->
        <div class="text-center" style="margin-bottom:32px">
          <p style="font-size:0.7rem;letter-spacing:0.2em;text-transform:uppercase;color:rgba(123,79,42,0.7);margin-bottom:8px">Why Choose Us</p>
          <h2 style="font-size:clamp(1.25rem,3vw,1.5rem);font-weight:700;color:#fff;margin:0">Our Quality Promise</h2>
        </div>

        <!-- Trust Cards Grid -->
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:24px;max-width:800px;margin:0 auto">

          <!-- Card 1: Warranty -->
          <div class="reveal" style="background:rgba(255,255,255,0.03);border:1px solid rgba(123,79,42,0.15);border-radius:14px;padding:24px 16px;text-align:center;transition:border-color 0.3s ease,box-shadow 0.3s ease,transform 0.3s ease;box-shadow:0 2px 12px rgba(0,0,0,0.15)">
            <!-- Icon -->
            <div style="width:40px;height:40px;margin:0 auto 14px;border-radius:10px;background:rgba(123,79,42,0.12);display:flex;align-items:center;justify-content:center">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--wood,#7b4f2a)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                <path d="M9 12l2 2 4-4" />
              </svg>
            </div>
            <!-- Stat -->
            <div style="font-size:1.5rem;font-weight:700;color:var(--wood,#7b4f2a);line-height:1.4;margin-bottom:4px">5 Year</div>
            <div style="font-size:0.8rem;font-weight:500;color:rgba(255,255,255,0.6);line-height:1.4;letter-spacing:0.02em">Warranty on Woodwork</div>
          </div>

          <!-- Card 2: Termite Proof -->
          <div class="reveal stagger-1" style="background:rgba(255,255,255,0.03);border:1px solid rgba(123,79,42,0.15);border-radius:14px;padding:24px 16px;text-align:center;transition:border-color 0.3s ease,box-shadow 0.3s ease,transform 0.3s ease;box-shadow:0 2px 12px rgba(0,0,0,0.15)">
            <!-- Icon -->
            <div style="width:40px;height:40px;margin:0 auto 14px;border-radius:10px;background:rgba(123,79,42,0.12);display:flex;align-items:center;justify-content:center">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--wood,#7b4f2a)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                <path d="M9 12l2 2 4-4" />
            ...
            <!-- Stat -->
            <div style="font-size:1.5rem;font-weight:700;color:var(--wood,#7b4f2a);line-height:1.4;margin-bottom:4px">100%</div>
            <div style="font-size:0.8rem;font-weight:500;color:rgba(255,255,255,0.6);line-height:1.4;letter-spacing:0.02em">Termite Proof Materials</div>
          </div>

          <!-- Card 3: Service Guarantee -->
          <div class="reveal stagger-2" style="background:rgba(255,255,255,0.03);border:1px solid rgba(123,79,42,0.15);border-radius:14px;padding:24px 16px;text-align:center;transition:border-color 0.3s ease,box-shadow 0.3s ease,transform 0.3s ease;box-shadow:0 2px 12px rgba(0,0,0,0.15)">
            <!-- Icon -->
            <div style="width:40px;height:40px;margin:0 auto 14px;border-radius:10px;background:rgba(123,79,42,0.12);display:flex;align-items:center;justify-content:center">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--wood,#7b4f2a)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                <circle cx="12" cy="12" r="10" />
            ...
            <!-- Stat -->
            <div style="font-size:1.5rem;font-weight:700;color:var(--wood,#7b4f2a);line-height:1.4;margin-bottom:4px">48 Hr</div>
            <div style="font-size:0.8rem;font-weight:500;color:rgba(255,255,255,0.6);line-height:1.4;letter-spacing:0.02em">Service Guarantee</div>
          </div>
    ...
    <style>
      section .reveal[style*="rgba(255,255,255,0.03)"]:hover {
        border-color: rgba(123, 79, 42, 0.35) !important;
        box-shadow: 0 4px 24px rgba(123, 79, 42, 0.12), 0 2px 12px rgba(0, 0, 0, 0.2) !important;

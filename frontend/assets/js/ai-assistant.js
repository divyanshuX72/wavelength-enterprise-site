    ...
    function getResponse(query) {
        ...
        if (q.includes('tv') || q.includes('television')) {
            return {
                ...
                extra: `
                   <div class="mt-2 w-[85%] bg-black/40 rounded-xl overflow-hidden border border-white/10 hover:border-wood/40 transition-colors group cursor-pointer" onclick="window.location.href='products.html?category=tv'">
        ...
        if (q.includes('bed') || q.includes('sleep')) {
            return {
                ...
                extra: `
                   <div class="mt-2 w-[85%] bg-black/40 rounded-xl overflow-hidden border border-white/10 hover:border-wood/40 transition-colors group cursor-pointer" onclick="window.location.href='products.html?category=beds'">
                      <div class="h-24 bg-gray-800 relative">
        ...
        if (q.includes('price') || q.includes('cost') || q.includes('budget') || q.includes('quote')) {
            return {
                ...
                extra: `
                   <a href="contact.html#quote" class="mt-2 inline-block bg-wood text-black px-4 py-2 rounded-lg text-sm font-bold hover:bg-white transition-colors">Get a Free Quote</a>
                `
            };
        }
            ...
            return {
                ...
                extra: `
                   <div class="flex gap-2 mt-2">
                     <a href="contact.html" class="bg-white/10 text-white px-3 py-1.5 rounded text-sm hover:bg-wood">View Map</a>
        ...
        return {
            ...
            extra: `<button onclick="window.location.href='products.html'" class="mt-2 text-xs text-wood hover:text-white underline underline-offset-4">Browse Full Catalog</button>`
        };
    }
